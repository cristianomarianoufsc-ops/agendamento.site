            ...
            <div className="flex flex-col space-y-8">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-md">
		                ...
		                <p className="text-sm text-gray-600 mb-4 p-2 bg-yellow-50 rounded-lg border border-yellow-200">
		                  **Atenção:** As datas e horários marcados em **amarelo** já foram solicitados por outro proponente. Você pode se inscrever nessas horas e concorrer à vaga mesmo assim. **A alocação final será definida para a proposta que obtiver a maior pontuação, conforme os critérios estabelecidos no item 8 do edital.**
		                </p>
