              ...
              <div className="bg-white p-6 rounded-2xl shadow-md">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {!viewOnly && sheetLink && <button onClick={() => window.open(sheetLink, '_blank')} className="flex items-center gap-2 px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 text-sm"><Sheet size={16} /> Ver na Planilha</button>}
                  </div>
                </div>
