            ...
            {mainTab === 'configuracoes_gerais' && !viewOnly && (
              <div className="space-y-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-md">
                  ...
                  <div className="mt-6"><button onClick={() => handleSaveConfig({ formsId, sheetLink: sheetId })} className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700"><Save size={18} /> Salvar IDs</button></div>
                </div>
